describe('login', () => {
    ...
    it('GET OUTFITS TEST', () => {
        ...
        cy.get('input[placeholder="user-id - the id of the user"]').type(`'exampleUserId'`);
    ...
    it('POST OUTFITS TEST', () => {
        ...
        cy.get('.try-out').click();
        cy.get('input[placeholder="user-id - user that creates the outfit"]').type(`'exampleUserId'`);
